...
const CreditNoteList: React.FC = () => {
  ...
  const fetchData = async () => {
    ...
    try {
      ...
      setCreditNoteList(response?.filter((item: CreditNote) => item.reason1 == "แต้มแลกส่วนลด"));
      setLoading(false);
    } catch (error) {
      setLoading(false);
  ...
  return (
    <ComponentCard title="ส่ง B1 รายการแต้มส่วนลด">
      <div className="flex flex-col  gap-4">
         <small className="mb-5">

              <b>หมายเหตุ : </b> <span>กรุณาไปปรับราคาแลกแต้มส่วนลดในหน้า "รายการใบลดหนี้" ก่อนที่จะส่ง B1</span>
            </small>
