...
const DiscountOffcanvas: React.FC<DiscountOffcanvasProps> = ({
  ...
  const isPayload = isDiscounted ? JSON.parse(data?.CNQR_calcurateDiscount?.find((row: any) => row.creditNoteItemId == item?.id).payload) :[0,1,2,3]
              ...
              <div>
                ...
                <h1 className="text-2xl font-bold text-gray-800">
                  ...
                  cardValues[activeIndex]?.displayProblemPercent !== undefined
                    ? Number(cardValues[activeIndex].displayProblemPercent)?.toFixed(2)
            ...
            <div className="mt-4 grid grid-cols-2 gap-2">
              ...
              <div>
                ...
                <h1 className="text-2xl font-bold text-gray-800">
                  {activeIndex !== null &&
                  cardValues[activeIndex]?.displayProblemPercent !== undefined
                    ? cardValues[activeIndex].displayProblemPercent
