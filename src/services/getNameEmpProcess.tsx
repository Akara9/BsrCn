...
const GetNameEmpProcess = async () => {
    ...
    try {
        const response = await fetch("https://203.114.108.46:6202/apicnqr/v1/nameEmProcessAll", requestOptions);
        if (!response.ok) {
...
export default GetNameEmpProcess;
